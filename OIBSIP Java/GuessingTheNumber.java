...
class Guess {
	...
	public boolean takeUserInput() {
		if (noOfGuesses < 10) {
			...
			System.out.println("All attemps are Over. Better luck next time!!\n");
			return true;
		}
	}
	...
	public boolean isGuessCorrect() {
		if (systemInput == userInput) {
			System.out.println(
					"WooHoooo, you guessed the number right " + systemInput + " in " + noOfGuesses + " guesses.");
...
public class GuessingTheNumber {
	...
	public static void main(String args[]) {
		...
		System.out.println("You will get 10 attempts to guess the number.\nGood luck!");
